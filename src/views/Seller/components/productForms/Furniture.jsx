...
import { ErrorMessage, ImageLoader, ImageUploader, TextAreaInput } from "../../../../Components/Common";
...
import { AddAPhotoRounded, AspectRatioRounded, CloseRounded, CloudUploadRounded, RadioButtonCheckedRounded } from "@mui/icons-material";


const schema = yup
  .object({
    sub_category: yup.string().required('Furniture category is required'),
    headline: yup.string().max(20).required("Furniture headline is required, don't you think?"),
