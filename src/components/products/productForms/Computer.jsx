...
const schema = yup
  .object({
    ...
    brand: yup
      ...
      .required("What's the brand?"),
    newness: yup.string().required("How new is it?"),
    color: yup.string(),
    ramsize: yup.number().required("What's the size of the RAM?"),
    storage: yup
      .number(4, "Can not exceed 4 characters")
      .required("What's the storage capacity?"),
    battery: yup
      .number()
      .max(6, "Can not exceed 6 characters")
      .required("What's the battery capacity?"),
